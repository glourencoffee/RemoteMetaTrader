...
public:
    RequestProcessor(Server& the_server, InstrumentEventSubject& instrument_event_subject);
...
//===========================================================================
RequestProcessor::RequestProcessor(Server& the_server, InstrumentEventSubject& instrument_event_subject)
    : m_server(GetPointer(the_server))
    , m_cmd_executor(instrument_event_subject)
{}
